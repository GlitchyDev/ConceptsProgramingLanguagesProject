...
public class CouplingObjectFactory {
    private final KeyWord[] NUMBER_OPERATIONS = new KeyWord[]{KeyWord.EXPONENTIAL,KeyWord.MULTIPLY, KeyWord.DIVIDE,
            KeyWord.INVERT_DIVIDE, KeyWord.NUMBER_ADD, KeyWord.NUMBER_SUBTRACT, KeyWord.NUMBER_IDENTITY, KeyWord.NUMBER_INVERT,
            KeyWord.STRING_CONCAT, KeyWord.LESS_THAN, KeyWord.GREATER_THAN,KeyWord.EQUAL_LESS_THAN, KeyWord.EQUAL_GREATER_THAN,
    ...
    public boolean createCoupling(KeyWord keyword,int couplingPosition) {
        switch(keyword) {
            case IF:
